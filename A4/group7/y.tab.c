...
static const yytype_uint16 yyrline[] =
{
     ...
     328,   329,   333,   341,   345,   352,   362,   371,   380,   388,
     392,   396,   404,   412,   413,   414,   415,   416,   418,   420,
     426,   431,   436,   437,   438,   439,   443,   448,   453,   458,
     463,   468,   475,   476,   477
};
#endif
...
#line 345 "parser.y" /* yacc.c:1646  */
    {
                                                        ...
                                                        is->if_condition = (yyvsp[-3].exp);
                                                        is->ThenPart = (yyvsp[-2].stmt);
                                                        is->ElsePart = (yyvsp[0].stmt);
                                                        (yyval.stmt) = is;
                                                    }
...
#line 352 "parser.y" /* yacc.c:1646  */
    {
                                                        auto is = new If_Statement();
                                                        is->if_condition = (yyvsp[-1].exp);
                                                        is->ThenPart = (yyvsp[0].stmt);
                                                        is->ElsePart = NULL;
                                                        (yyval.stmt) = is;
                                                    }
...
#line 362 "parser.y" /* yacc.c:1646  */
    {
                                                                                            ...
                                                                                            ws->condition = (yyvsp[-2].exp);
                                                                                            ws->body = (yyvsp[-5].stmt);
                                                                                            (yyval.stmt) = ws;
                                                                                        }
